...
class AppDate {
  ...
  static String dateTimeWithDay(DateTime dateTime, String language) =>
      DateFormat.yMMMEd(language).add_jm().format(
            dateTime,
          );
  ...
  static String expiryDate(DateTime dateTime, String language) =>
      DateFormat.yMMMM(language).format(
        dateTime,
      );

  static String dateDto(DateTime dateTime) =>
      DateFormat('yyyy-MM-dd').add_Hm().format(
            dateTime,
          );
  static String dateDtoWithoutHour(DateTime dateTime) =>
